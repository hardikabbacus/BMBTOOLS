<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="ViewImportInventoryJobs.aspx.cs" Inherits="Admin_ViewImportInventoryJobs" %>
        ...
        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 search_bar">
                                    <div class="col-sm-4 job_dtls_btns">
                                        ...
                                        <asp:Button ID="imgbtnCancelJob" OnClick="imgbtnCancelJob_Click" runat="server" Text="Cancel Job" class="btn btn-info " />
            ...
            <div class="col-sm-12 ">
                <div class="box">
                    ...
                    <asp:GridView ID="gvImportjob" runat="server" AllowSorting="true" CssClass="table table-bordered table-striped dataTable"
                        GridLines="None" DataKeyNames="id" PagerStyle-CssClass="paging-link" role="grid"
                        AutoGenerateColumns="false" ShowFooter="false" OnRowDataBound="gvImportjob_RowDataBound" OnSorting="gvImportjob_Sorting"
