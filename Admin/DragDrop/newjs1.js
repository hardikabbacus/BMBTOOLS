...
$(document).ready(function () {
	...
	*****************************/
    ...
    defaultUploadBtn = $('#filenew');
    var dropZone = $("#" + dropZoneId);
    var ooleft = dropZone.offset().left;
    var ooright = dropZone.outerWidth() + ooleft;
    var ootop = dropZone.offset().top;
    var oobottom = dropZone.outerHeight() + ootop;
    var inputFile = dropZone.find("#filenew");
    ...
    defaultUploadBtn.on('change', function () {
        ...
        if (files.length > 1) {
            alert('you cannot upload more then one image.');
        }
        else if (count > 0) {
            alert('you cannot upload more then one image.');
        }
	...
	*****************************/
    var createPreview = function (file, newURL) {
        ...
        imageObj.fileNamewithoutspace = filenames.replace(/\s/g, '');
        //extend filename
        var effect = $('input[name=effect]:checked').val();
        if (effect == 'grayscale') {
