...
public partial class Admin_viewlanguage : System.Web.UI.Page
{
    int pageNo = new int();
    ...
    {
        Page.Title = "Language List - " + System.Configuration.ConfigurationManager.AppSettings["AminPageTitle"];
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["flag"] == "add")
            {
                //trmsg.Visible = true;
                lblmsg.Visible = true;
                lblmsgs.Text = "Language has been added successfully";
            }
            else if (Request.QueryString["flag"] == "edit")
            {
                // trmsg.Visible = true;
                lblmsg.Visible = true;
                lblmsgs.Text = "Language has been updated successfully";
            }
            else if (Request.QueryString["flag"] == "delete")
            {
                //trmsg.Visible = true;
                lblmsg.Visible = true;
                lblmsgs.Text = "Language has been deleted successfully";
            }
    ...
    {
        Response.Redirect("add_language.aspx");
    }
