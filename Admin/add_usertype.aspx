<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="add_usertype.aspx.cs" Inherits="Admin_add_usertype" %>
                    ...
                    <form class="form-horizontal">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <asp:TextBox ID="txtadmintype" runat="server" class="form-control" ></asp:TextBox>
                                    <asp:RequiredFieldValidator CssClass="Required" ForeColor="Red" ID="reqtxtadmintype" runat="server" ControlToValidate="txtadmintype" Display="Dynamic" ErrorMessage="Please enter admin type" ValidationGroup="btnsave" EnableViewState="false"></asp:RequiredFieldValidator>
                                </div>
                            </div>
